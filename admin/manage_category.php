...
<head>
    <meta charset="UTF-8">
    <title>Category Management - WaaWeeWoo Bookstore</title>
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    echo"<td class='text-end'>
                            <div class='btn-group' role='group'>
                                ...
                                <a href='delete_category.php?id=" . $row['id'] . "' class='btn btn-sm btn-outline-danger' onclick=\"return confirm('Are you sure you want to delete category " . htmlspecialchars($row['name']) . "?');\" title='Delete Category'><i class='fas fa-trash'></i></a>
                            </div>
                         </td>";
                    echo"</tr>";
                };
